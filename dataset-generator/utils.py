...
def get_input_features(identifier_list):
    ...
    for noisy_stft_magnitude_features in identifier_list:
        ...
        input_features = prepare_input_features(noisy_stft_magnitude_features)
...
def get_tf_feature(
    noisy_stft_magnitude_features, clean_stft_magnitude, noise_stft_phase
):
    ...
    example = tf.train.Example(
        features=tf.train.Features(
            feature={
                ...
                "noisy_stft_magnitude_features": _bytes_feature(
